...
v={"a": a, "b": b}   ## Should be v = {"a": 2, "b": 3}

assert v=={"a":2, "b":3}

## Didn't answere question: Dictionaries can be identified by {} the curly 
## braces, where lists have [] square brackets.
...
v2={}
v2["a"]=a  ## Should be v2["a"] = 2
v2["b"]=b  ## Should be v2["b"] = 3
